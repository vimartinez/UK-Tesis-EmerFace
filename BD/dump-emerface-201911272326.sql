...
--
-- Host: localhost    Database: emerface
-- ------------------------------------------------------
...
--
-- Table structure for table `img_pacientes`
--

DROP TABLE IF EXISTS `img_pacientes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `img_pacientes` (
  `img_id` int(11) NOT NULL,
  `pac_id` int(11) NOT NULL,
  `img_img` blob NOT NULL,
  `img_path` varchar(255) COLLATE utf8_spanish2_ci NOT NULL,
  PRIMARY KEY (`img_id`),
  KEY `paciente4` (`pac_id`),
  CONSTRAINT `paciente4` FOREIGN KEY (`pac_id`) REFERENCES `pacientes` (`pac_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `img_pacientes`
--

LOCK TABLES `img_pacientes` WRITE;
/*!40000 ALTER TABLE `img_pacientes` DISABLE KEYS */;
INSERT INTO `img_pacientes` VALUES (1,1,'','web/imgPacientes/1/01.jpg'),(2,1,'','web/imgPacientes/1/02.jpg'),(3,1,'','web/imgPacientes/1/04.jpg'),(4,1,'','web/imgPacientes/1/03.jpg'),(5,1,'','web/imgPacientes/1/05.jpg'),(6,1,'','web/imgPacientes/1/06.JPG'),(7,2,'','web/imgPacientes/2/01.jpg'),(8,2,'','web/imgPacientes/2/02.jpg'),(9,2,'','web/imgPacientes/2/03.jpg'),(10,2,'','web/imgPacientes/2/04.jpg'),(11,2,'','web/imgPacientes/2/05.jpg'),(12,2,'','web/imgPacientes/2/06.jpg'),(13,2,'','web/imgPacientes/2/09.jpg'),(14,2,'','web/imgPacientes/2/08.jpg'),(15,3,'','web/imgPacientes/3/01.JPG'),(16,3,'','web/imgPacientes/3/02.jpg'),(17,3,'','web/imgPacientes/3/03.JPG'),(18,3,'','web/imgPacientes/3/04.jpg'),(19,3,'','web/imgPacientes/3/05.JPG'),(20,3,'','web/imgPacientes/3/06.JPG'),(21,3,'','web/imgPacientes/3/07.jpg'),(22,4,'','web/imgPacientes/4/05.jpg'),(23,4,'','web/imgPacientes/4/01.jpg'),(24,4,'','web/imgPacientes/4/02.jpg'),(25,4,'','web/imgPacientes/4/04.JPG'),(26,4,'','web/imgPacientes/4/06.jpg'),(27,4,'','web/imgPacientes/4/07.jpg'),(28,4,'','web/imgPacientes/4/08.jpg'),(29,4,'','web/imgPacientes/4/09.jpg'),(30,5,'','web/imgPacientes/5/01.jpg'),(31,5,'','web/imgPacientes/5/02.jpg'),(32,5,'','web/imgPacientes/5/03.JPG'),(33,5,'','web/imgPacientes/5/04.jpg'),(34,6,'','web/imgPacientes/6/01.jpg'),(35,6,'','web/imgPacientes/6/02.jpg'),(36,6,'','web/imgPacientes/6/03.jpg'),(37,6,'','web/imgPacientes/6/04.jpg'),(38,6,'','web/imgPacientes/6/05.jpg'),(39,6,'','web/imgPacientes/6/06.JPG'),(40,7,'','web/imgPacientes/7/01.jpg'),(41,7,'','web/imgPacientes/7/02.jpg'),(42,7,'','web/imgPacientes/7/03.jpg'),(43,7,'','web/imgPacientes/7/04.JPG'),(44,7,'','web/imgPacientes/7/05.jpg'),(45,7,'','web/imgPacientes/7/06.jpg'),(46,7,'','web/imgPacientes/7/07.JPG'),(47,7,'','web/imgPacientes/7/08.JPG'),(48,8,'','web/imgPacientes/8/01.jpg'),(49,8,'','web/imgPacientes/8/02.jpg'),(50,8,'','web/imgPacientes/8/03.jpg'),(51,8,'','web/imgPacientes/8/04.jpg'),(52,8,'','web/imgPacientes/8/05.jpg'),(53,8,'','web/imgPacientes/8/06.jpg'),(54,8,'','web/imgPacientes/8/07.jpg'),(55,9,'','web/imgPacientes/9/01.jpg'),(56,9,'','web/imgPacientes/9/02.jpeg'),(57,9,'','web/imgPacientes/9/03.jpg'),(58,9,'','web/imgPacientes/9/04.jpg'),(59,9,'','web/imgPacientes/9/05.jpg'),(60,9,'','web/imgPacientes/9/06.jpg'),(61,9,'','web/imgPacientes/9/10.JPG'),(62,9,'','web/imgPacientes/9/08.jpg'),(63,10,'','web/imgPacientes/10/01.jpg'),(64,10,'','web/imgPacientes/10/05.jpg'),(65,10,'','web/imgPacientes/10/06.jpg'),(66,10,'','web/imgPacientes/10/11.jpg'),(67,10,'','web/imgPacientes/10/09.jpg'),(68,10,'','web/imgPacientes/10/10.jpg'),(69,10,'','web/imgPacientes/10/07.jpg'),(70,10,'','web/imgPacientes/10/04.jpg');
/*!40000 ALTER TABLE `img_pacientes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `medicos` (
  ...
  `med_matricula` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `med_direccion` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `med_piso` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `med_depto` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `med_localidad` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `med_documento` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  ...
  KEY `usuario` (`usu_id`),
  KEY `documento` (`tdoc_id`),
  CONSTRAINT `documento` FOREIGN KEY (`tdoc_id`) REFERENCES `tipos_doc` (`tdoc_id`),
  CONSTRAINT `especialidad` FOREIGN KEY (`esp_id`) REFERENCES `medicos_especialidades` (`esp_id`),
  CONSTRAINT `usuario` FOREIGN KEY (`usu_id`) REFERENCES `usuarios` (`usu_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medicos_especialidades` (
  `esp_id` int(11) NOT NULL,
  `esp_descrip` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  PRIMARY KEY (`esp_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `pac_pat_tratam`
--

DROP TABLE IF EXISTS `pac_pat_tratam`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pac_pat_tratam` (
  `pat_id` int(11) NOT NULL,
  `pac_id` int(11) NOT NULL,
  `trat_nombre` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `trat_descrip` varchar(500) COLLATE utf8_spanish2_ci NOT NULL,
  PRIMARY KEY (`pat_id`,`pac_id`),
  KEY `pac_id` (`pac_id`,`pat_id`),
  CONSTRAINT `pac_pat_tratam_ibfk_1` FOREIGN KEY (`pac_id`, `pat_id`) REFERENCES `pacientes_patologias` (`pac_id`, `pat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pac_pat_tratam`
--

LOCK TABLES `pac_pat_tratam` WRITE;
/*!40000 ALTER TABLE `pac_pat_tratam` DISABLE KEYS */;
INSERT INTO `pac_pat_tratam` VALUES (1,1,'Valsartan 10mg diarios, en el desayuno','Tratamiento farmacológico'),(1,5,'Levotiroxina 100mg una vez al día','Hormona via oral'),(5,4,'comer menmos','comer menos'),(6,1,'Respirar aire puro','Tram epoc'),(8,5,'Administracion via oral de ser necesario','Medicamento para el asma');
/*!40000 ALTER TABLE `pac_pat_tratam` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pacientes` (
  `pac_id` int(11) NOT NULL,
  `pac_nombreApe` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `pac_direccion` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `pac_piso` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `pac_depto` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `pac_localidad` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `tdoc_id` int(11) NOT NULL,
  `pac_documento` varchar(20) COLLATE utf8_spanish2_ci NOT NULL,
  `Pac_grupoSang` varchar(50) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `pac_FechaNac` varchar(20) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `pac_sexo` varchar(3) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `prov_id` int(11) NOT NULL,
  PRIMARY KEY (`pac_id`),
  KEY `docu3` (`tdoc_id`),
  CONSTRAINT `docu3` FOREIGN KEY (`tdoc_id`) REFERENCES `tipos_doc` (`tdoc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pacientes` VALUES (1,'Anibal Pacheco','Mariano Moreno 1254','','','La Costa',1,'30432126','A+','1986-06-17','M',1),(2,'Alejandro Carmelo','Alvarez Thomas 2341','3','B','CABA',1,'30123456','0-','1980-08-20','M',3),(3,'Emiliano Cáceres','Pasaje Temperley','3','C','Lomas de Zamora',1,'33456123','A-','1979-03-13','M',1),(4,'Victor Martinez','Mariano Moreno 1254','','','Merlo',1,'33123123','A+','1988-06-14','M',1),(5,'Juan Rosteti','Corrientes 348','2','A','CABA',1,'30123456','A-','1991-07-17','M',3),(6,'Juan Forestello','Capdevilla 2342','','','Lomas de Zamora',1,'22134234','0-','1979-01-08','M',1),(7,'Gustavo Castillo','Maipu','','','San Rafael',1,'22123123','A+','1971-04-19','0',14),(8,'Nicolas Sanchez Molina','Azara 123','3','C','Viedma',1,'26345123','A-','1998-04-22','M',17),(9,'Gabriel Batistuta','Belgrano 1234','','','Reconquista',1,'23123123','A+','1973-04-10','M',22),(10,'Lio Messi','Sarmiento 123','','','Rosario',1,'34123123','0+','1992-02-12','M',22),(11,'Leonel Vallejos','Montes de Oca 123','','','Bariloche',1,'22123123','0+','1985-02-19','M',17);
/*!40000 ALTER TABLE `pacientes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pacientes_patologias`
--

DROP TABLE IF EXISTS `pacientes_patologias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pacientes_patologias` (
  ...
  PRIMARY KEY (`pat_id`,`pac_id`),
  KEY `pac2` (`pac_id`),
  CONSTRAINT `pac2` FOREIGN KEY (`pac_id`) REFERENCES `pacientes` (`pac_id`),
  CONSTRAINT `pat2` FOREIGN KEY (`pat_id`) REFERENCES `patologias` (`pat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pacientes_patologias`
--

LOCK TABLES `pacientes_patologias` WRITE;
/*!40000 ALTER TABLE `pacientes_patologias` DISABLE KEYS */;
INSERT INTO `pacientes_patologias` VALUES (1,1),(1,5),(2,5),(3,9),(5,4),(5,8),(6,1),(6,8),(7,7),(8,1),(8,5),(8,8),(9,7);
/*!40000 ALTER TABLE `pacientes_patologias` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `patologias` (
  `pat_id` int(11) NOT NULL,
  `pat_nombre` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `pat_descrip` varchar(500) COLLATE utf8_spanish2_ci NOT NULL,
  `pat_critica` int(11) NOT NULL,
  PRIMARY KEY (`pat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `patologias` VALUES (1,'Hipertensión','Alta presión sanguínea',0),(2,'Hipotiroidismo','Funcionamiento deficiente de la glandula tiróidces',0),(3,'Diabetes','Se caracterizada por la hiperglucemia (alta concentración de azúcar en sangre, es decir, glucosa) y problemas que derivan de ello: problemas cardiovasculares, renales, etc. Existen diferentes tipos de diabetes, por ejemplo, la diabetes tipo I, la diabetes tipo II, la gestacional, etc.',0),(4,'Angina de Pecho','',0),(5,'Obesidad','La obesidad es una enfermedad crónica con una elevada prevalencia a nivel mundial que, generalmente, viene asociada con multitud de complicaciones para la salud.',0),(6,'EPOC','La enfermedad pulmonar obstructiva crónica EPOC es una patología respiratoria que provoca un daño progresivo en el sistema respiratorio, y dificulta y disminuye la capacidad de inhalar aire. Puede originar bronquitis crónica o enfisema, y su causa principal es el tabaquismo. ',1),(7,'Hepatitis','Son muchas las enfermedades hepáticas, y todas ellas tienen diferentes causas. Por ejemplo, por virus, en el caso de la hepatitis; por medicamentos o tóxicos como el alcohol, en el caso de la cirrosis… Muchos de estos trastornos pueden tener consecuencias serias si no se tratan correctamente y pueden llegar a causar la muerte.',1),(8,'Asma','Hinchazón de las vías respiratorias con producción de una mayor cantidad de mucosa de lo normal, ocasionando dificultades en la respieración',1),(9,'Insuficiencia cardíaca','Afección crónica que provoca que el corazón no bombee sangre con la eficiencia necesaria. Puede deberse a que el corazón no bombea (sístole) o no se llena (diástole) correctamente.',1),(11,'Cáncer','Algunas células anómalas se dividen sin control y destruyen los tejidos corporales.',0),(12,'Trastornos mentales','Trastornos mentales - Demencia',1);
...
CREATE TABLE `personas_contacto` (
  ...
  `pac_id` int(11) NOT NULL,
  `pers_nombreApe` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_documento` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_telefono` varchar(20) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_relacion` varchar(20) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_mail` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_direccion` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_piso` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_depto` varchar(10) COLLATE utf8_spanish2_ci NOT NULL,
  `pers_localidad` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
  `prov_id` int(11) NOT NULL,
  `tdoc_id` int(11) NOT NULL,
  PRIMARY KEY (`pers_id`),
  KEY `paciente` (`pac_id`),
  KEY `docu2` (`tdoc_id`),
  CONSTRAINT `docu2` FOREIGN KEY (`tdoc_id`) REFERENCES `tipos_doc` (`tdoc_id`),
  CONSTRAINT `paciente` FOREIGN KEY (`pac_id`) REFERENCES `pacientes` (`pac_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `personas_contacto` WRITE;
/*!40000 ALTER TABLE `personas_contacto` DISABLE KEYS */;
INSERT INTO `personas_contacto` VALUES (1,1,'Maria Gomez','34567123','4323 1234','Esposa','marigagomez@mail.com','Mariano Moreno 1254','','','La Costa',1,1),(2,5,'Julieta Rosteti','34567345','2341234','Hermana','julirosti@mail.com','Av Jujuy 1234','3','C','Berazategui',1,1),(3,7,'Mariela Gonzalez','24123123','22312343','Esposa','marigonza@mail.com.ar','Av San Martin 323','','','San Rafael',14,1),(4,8,'Evelyn Rodriguez','36123123','155 123 456','Cónyugue','evelinarodri@mail.com','Azara 123','3','C','Viedma',17,1);
/*!40000 ALTER TABLE `personas_contacto` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tipos_doc` (
  `tdoc_id` int(11) NOT NULL,
  `tdoc_descrip` varchar(20) COLLATE utf8_spanish2_ci NOT NULL,
  PRIMARY KEY (`tdoc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tipos_doc` VALUES (1,'DNI');
...
INSERT INTO `usuarios` VALUES (1,1,'Victor Martinez','vic','victor','2017-10-01 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,'25987147',0),(2,3,'Victor Martinez','vimartinez','123456','2017-10-27 17:39:37',NULL,'Matheu 845','barrio','Banfield',1,'victordmart@gmail.com','23234234',0);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'emerface'
--
...
-- Dump completed on 2019-11-27 23:26:14
