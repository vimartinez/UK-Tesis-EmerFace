...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-02-2019 a las 03:48:14
...
--
-- Base de datos: `emerface`
--
CREATE DATABASE IF NOT EXISTS `emerface` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci;
USE `emerface`;
...
--
-- Estructura de tabla para la tabla `img_pacientes`
--
...
--
-- Volcado de datos para la tabla `img_pacientes`
--

INSERT INTO `img_pacientes` (`img_id`, `pac_id`, `img_img`, `img_path`) VALUES
(1, 1, '', 'web/imgPacientes/1/01.jpg'),
(2, 1, '', 'web/imgPacientes/1/02.jpg'),
(3, 1, '', 'web/imgPacientes/1/04.jpg'),
(4, 1, '', 'web/imgPacientes/1/03.jpg'),
(5, 1, '', 'web/imgPacientes/1/05.jpg'),
(6, 1, '', 'web/imgPacientes/1/06.JPG'),
(7, 2, '', 'web/imgPacientes/2/01.jpg'),
(8, 2, '', 'web/imgPacientes/2/02.jpg'),
(9, 2, '', 'web/imgPacientes/2/03.jpg'),
(10, 2, '', 'web/imgPacientes/2/04.jpg'),
(11, 2, '', 'web/imgPacientes/2/05.jpg'),
(12, 2, '', 'web/imgPacientes/2/06.jpg'),
(13, 2, '', 'web/imgPacientes/2/09.jpg'),
(14, 2, '', 'web/imgPacientes/2/08.jpg'),
(15, 3, '', 'web/imgPacientes/3/01.JPG'),
(16, 3, '', 'web/imgPacientes/3/02.jpg'),
(17, 3, '', 'web/imgPacientes/3/03.JPG'),
(18, 3, '', 'web/imgPacientes/3/04.jpg'),
(19, 3, '', 'web/imgPacientes/3/05.JPG'),
(20, 3, '', 'web/imgPacientes/3/06.JPG'),
(21, 3, '', 'web/imgPacientes/3/07.jpg'),
(22, 4, '', 'web/imgPacientes/4/05.jpg'),
(23, 4, '', 'web/imgPacientes/4/01.jpg'),
(24, 4, '', 'web/imgPacientes/4/02.jpg'),
(25, 4, '', 'web/imgPacientes/4/04.JPG'),
(26, 4, '', 'web/imgPacientes/4/06.jpg'),
(27, 4, '', 'web/imgPacientes/4/07.jpg'),
(28, 4, '', 'web/imgPacientes/4/08.jpg'),
(29, 4, '', 'web/imgPacientes/4/09.jpg'),
(30, 5, '', 'web/imgPacientes/5/01.jpg'),
(31, 5, '', 'web/imgPacientes/5/02.jpg'),
(32, 5, '', 'web/imgPacientes/5/03.JPG'),
(33, 5, '', 'web/imgPacientes/5/04.jpg'),
(34, 6, '', 'web/imgPacientes/6/01.jpg'),
(35, 6, '', 'web/imgPacientes/6/02.jpg'),
(36, 6, '', 'web/imgPacientes/6/03.jpg'),
(37, 6, '', 'web/imgPacientes/6/04.jpg'),
(38, 6, '', 'web/imgPacientes/6/05.jpg'),
(39, 6, '', 'web/imgPacientes/6/06.JPG'),
(40, 7, '', 'web/imgPacientes/7/01.jpg'),
(41, 7, '', 'web/imgPacientes/7/02.jpg'),
(42, 7, '', 'web/imgPacientes/7/03.jpg'),
(43, 7, '', 'web/imgPacientes/7/04.JPG'),
(44, 7, '', 'web/imgPacientes/7/05.jpg'),
(45, 7, '', 'web/imgPacientes/7/06.jpg'),
(46, 7, '', 'web/imgPacientes/7/07.JPG'),
(47, 7, '', 'web/imgPacientes/7/08.JPG'),
(48, 8, '', 'web/imgPacientes/8/01.jpg'),
(49, 8, '', 'web/imgPacientes/8/02.jpg'),
(50, 8, '', 'web/imgPacientes/8/03.jpg'),
(51, 8, '', 'web/imgPacientes/8/04.jpg'),
(52, 8, '', 'web/imgPacientes/8/05.jpg'),
(53, 8, '', 'web/imgPacientes/8/06.jpg'),
(54, 8, '', 'web/imgPacientes/8/07.jpg'),
(55, 9, '', 'web/imgPacientes/9/01.jpg'),
(56, 9, '', 'web/imgPacientes/9/02.jpeg'),
(57, 9, '', 'web/imgPacientes/9/03.jpg'),
(58, 9, '', 'web/imgPacientes/9/04.jpg'),
(59, 9, '', 'web/imgPacientes/9/05.jpg'),
(60, 9, '', 'web/imgPacientes/9/06.jpg'),
(61, 9, '', 'web/imgPacientes/9/10.JPG'),
(62, 9, '', 'web/imgPacientes/9/08.jpg'),
(63, 10, '', 'web/imgPacientes/10/01.jpg'),
(64, 10, '', 'web/imgPacientes/10/05.jpg'),
(65, 10, '', 'web/imgPacientes/10/06.jpg'),
(66, 10, '', 'web/imgPacientes/10/11.jpg'),
(67, 10, '', 'web/imgPacientes/10/09.jpg'),
(68, 10, '', 'web/imgPacientes/10/10.jpg'),
(69, 10, '', 'web/imgPacientes/10/07.jpg'),
(70, 10, '', 'web/imgPacientes/10/04.jpg');
...
INSERT INTO `pacientes` (`pac_id`, `pac_nombreApe`, `pac_direccion`, `pac_piso`, `pac_depto`, `pac_localidad`, `tdoc_id`, `pac_documento`, `Pac_grupoSang`, `pac_FechaNac`, `pac_sexo`) VALUES
(1, 'Anibal P', 'Mariano Moreno 1254', '', '', 'La Costa', 1, '30432126', 'A+', '1986-06-17', 'M'),
(2, 'Alejandro Car', 'Alvarez Thomas 2341', '3', 'B', 'CABA', 1, '30123456', '0-', '1980-08-20', 'M'),
(3, 'Emiliano Cáceres', 'Pasaje Temperley', '3', 'C', 'Lomas de Zamora', 1, '33456123', 'A-', '1979-03-13', '0'),
(4, 'Victor Martinez', 'Mariano Moreno 1254', '', '', 'Merlo', 1, '33123123', 'A+', '1988-06-14', 'M'),
(5, 'Juan Rosteti', 'Corrientes 348', '2', 'A', 'CABA', 1, '30123456', 'A-', '1991-07-17', 'M'),
(6, 'Juan Forestello', 'Capdevilla 2342', '', '', 'Lomas de Zamora', 1, '22134234', '0-', '1979-01-08', '0'),
(7, 'Gustavo Castillo', 'Maipu', '', '', 'San Rafael', 1, '22123123', 'A+', '1971-04-19', '0'),
(8, 'Nicolas Sanchez Molina', 'Azara 123', '3', 'C', 'Viedma', 1, '26345123', 'A-', '1998-04-22', 'M'),
(9, 'Gabriel Batistuta', 'Belgrano 1234', '', '', 'Reconquista', 1, '23123123', 'A+', '1973-04-10', 'M'),
(10, 'Lio Messi', 'Sarmiento 123', '', '', 'Rosario', 1, '34123123', '0+', '1992-02-12', '0');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pacientes_patologias`
--
...
--
-- Volcado de datos para la tabla `pacientes_patologias`
--

INSERT INTO `pacientes_patologias` (`pat_id`, `pac_id`) VALUES
(1, 1),
(1, 5),
(2, 5),
(5, 8),
...
--
-- Estructura de tabla para la tabla `pac_pat_tratam`
--
...
--
-- Volcado de datos para la tabla `pac_pat_tratam`
--

INSERT INTO `pac_pat_tratam` (`pat_id`, `pac_id`, `trat_nombre`, `trat_descrip`) VALUES
(1, 1, 'Valsartan 10mg diarios, en el desayuno', 'Tratamiento farmacológico'),
(1, 5, 'Levotiroxina 100mg una vez al d[ia', 'Hormona via oral'),
(8, 5, 'Administracion via oral de ser necesario', 'Medicamento para el asma');
...
INSERT INTO `patologias` (`pat_id`, `pat_nombre`, `pat_descrip`, `pat_critica`) VALUES
(1, 'Hipertensión', 'Alta presión sanguínea', 0),
(2, 'Hipotiroidismo', 'Funcionamiento deficiente de la glandula tiróidces', 0),
(3, 'Diabetes', 'Se caracterizada por la hiperglucemia (alta concentración de azúcar en sangre, es decir, glucosa) y problemas que derivan de ello: problemas cardiovasculares, renales, etc. Existen diferentes tipos de diabetes, por ejemplo, la diabetes tipo I, la diabetes tipo II, la gestacional, etc.', 0),
(4, 'Angina de Pecho', '', 0),
(5, 'Obesidad', 'La obesidad es una enfermedad crónica con una elevada prevalencia a nivel mundial que, generalmente, viene asociada con multitud de complicaciones para la salud.', 0),
(6, 'EPOC', 'La enfermedad pulmonar obstructiva crónica EPOC es una patología respiratoria que provoca un daño progresivo en el sistema respiratorio, y dificulta y disminuye la capacidad de inhalar aire. Puede originar bronquitis crónica o enfisema, y su causa principal es el tabaquismo. ', 1),
(7, 'Hepatitis', 'Son muchas las enfermedades hepáticas, y todas ellas tienen diferentes causas. Por ejemplo, por virus, en el caso de la hepatitis; por medicamentos o tóxicos como el alcohol, en el caso de la cirrosis… Muchos de estos trastornos pueden tener consecuencias serias si no se tratan correctamente y pueden llegar a causar la muerte.', 1),
(8, 'Asma', 'Hinchazón de las vías respiratorias con producción de una mayor cantidad de mucosa de lo normal, ocasionando dificultades en la respieración', 1),
(9, 'Insuficiencia cardíaca', 'Afección crónica que provoca que el corazón no bombee sangre con la eficiencia necesaria. Puede deberse a que el corazón no bombea (sístole) o no se llena (diástole) correctamente.', 1),
(11, 'Cáncer', 'Algunas células anómalas se dividen sin control y destruyen los tejidos corporales.', 0),
(12, 'Trastornos mentales', 'Trastornos mentales - Demencia', 1);
...
INSERT INTO `personas_contacto` (`pers_id`, `pac_id`, `pers_nombreApe`, `pers_documento`, `pers_telefono`, `pers_relacion`, `pers_mail`, `pers_direccion`, `pers_piso`, `pers_depto`, `pers_localidad`, `prov_id`, `tdoc_id`) VALUES
(1, 1, 'Maria Gomez', '34567123', '4323 1234', 'Esposa', 'marigagomez@mail.com', 'Mariano Moreno 1254', '', '', 'La Costa', 1, 1),
(2, 5, 'Julieta Rosteti', '34567345', '2341234', 'Hermana', 'julirosti@mail.com', 'Av Jujuy 1234', '3', 'C', 'Berazategui', 1, 1),
(3, 7, 'Mariela Gonzalez', '24123123', '22312343', 'Esposa', 'marigonza@mail.com.ar', 'Av San Martin 323', '', '', 'San Rafael', 14, 1);
...
INSERT INTO `tipos_doc` (`tdoc_id`, `tdoc_descrip`) VALUES
(1, 'DNI');
...
(2, 3, 'Victor Martinez', 'vimartinez', '123456', '2017-10-27 17:39:37', NULL, 'Matheu 845', 'barrio', 'Banfield', 1, 'victordmart@gmail.com', '23234234', 0);
...
--
-- Indices de la tabla `img_pacientes`
--
ALTER TABLE `img_pacientes`
  ADD PRIMARY KEY (`img_id`),
  ADD KEY `paciente4` (`pac_id`);
...
ALTER TABLE `medicos`
  ...
  ADD KEY `especialidad` (`esp_id`),
  ADD KEY `usuario` (`usu_id`),
  ADD KEY `documento` (`tdoc_id`);
...
ALTER TABLE `pacientes`
  ...
  ADD KEY `docu3` (`tdoc_id`);

--
-- Indices de la tabla `pacientes_patologias`
--
ALTER TABLE `pacientes_patologias`
  ADD PRIMARY KEY (`pat_id`,`pac_id`),
  ADD KEY `pac2` (`pac_id`);

--
-- Indices de la tabla `pac_pat_tratam`
--
ALTER TABLE `pac_pat_tratam`
  ADD PRIMARY KEY (`pat_id`,`pac_id`),
  ADD KEY `pac_id` (`pac_id`,`pat_id`);
...
ALTER TABLE `personas_contacto`
  ...
  ADD KEY `paciente` (`pac_id`),
  ADD KEY `docu2` (`tdoc_id`);
...
--
-- Filtros para la tabla `img_pacientes`
--
ALTER TABLE `img_pacientes`
  ADD CONSTRAINT `paciente4` FOREIGN KEY (`pac_id`) REFERENCES `pacientes` (`pac_id`);

--
-- Filtros para la tabla `medicos`
--
ALTER TABLE `medicos`
  ADD CONSTRAINT `documento` FOREIGN KEY (`tdoc_id`) REFERENCES `tipos_doc` (`tdoc_id`),
  ADD CONSTRAINT `especialidad` FOREIGN KEY (`esp_id`) REFERENCES `medicos_especialidades` (`esp_id`),
  ADD CONSTRAINT `usuario` FOREIGN KEY (`usu_id`) REFERENCES `usuarios` (`usu_ID`);

--
-- Filtros para la tabla `pacientes`
--
ALTER TABLE `pacientes`
  ADD CONSTRAINT `docu3` FOREIGN KEY (`tdoc_id`) REFERENCES `tipos_doc` (`tdoc_id`);

--
-- Filtros para la tabla `pacientes_patologias`
--
ALTER TABLE `pacientes_patologias`
  ADD CONSTRAINT `pac2` FOREIGN KEY (`pac_id`) REFERENCES `pacientes` (`pac_id`),
  ADD CONSTRAINT `pat2` FOREIGN KEY (`pat_id`) REFERENCES `patologias` (`pat_id`);

--
-- Filtros para la tabla `pac_pat_tratam`
--
ALTER TABLE `pac_pat_tratam`
  ADD CONSTRAINT `pac_pat_tratam_ibfk_1` FOREIGN KEY (`pac_id`,`pat_id`) REFERENCES `pacientes_patologias` (`pac_id`, `pat_id`);
...
--
ALTER TABLE `personas_contacto`
  ADD CONSTRAINT `docu2` FOREIGN KEY (`tdoc_id`) REFERENCES `tipos_doc` (`tdoc_id`),
  ADD CONSTRAINT `paciente` FOREIGN KEY (`pac_id`) REFERENCES `pacientes` (`pac_id`);
